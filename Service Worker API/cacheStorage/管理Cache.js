...
const testCacheStorage = async function () {
    ...
    const testCache1 = await caches.open("testCache1");
    const testCache2 = await caches.open("testCache2");
    const testCache3 = await caches.open("testCache3");
    const testCache4 = await caches.open("testCache4");
