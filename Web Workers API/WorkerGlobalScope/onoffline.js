...
self.addEventListener("languagechange", function (event) {
    ...
    // 显示通知
    event.waitUntil(self.registration.showNotification("languagechange", {
        body: "languagechange",
    }));
});
// 监听在线事件
self.addEventListener("online", function (event) {
    ...
    // 显示通知
    event.waitUntil(self.registration.showNotification("online", {
        body: "online",
    }));
});
// 监听离线事件
self.addEventListener("offline", function (event) {
    ...
    // 显示通知
    event.waitUntil(self.registration.showNotification("offline", {
        body: "offline",
    }));
});
// 监听 promise 拒绝处理完成事件
